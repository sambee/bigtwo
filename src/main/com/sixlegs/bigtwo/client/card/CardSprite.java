//
// $Id: CardSprite.java 18 2006-11-14 02:56:48Z herbyderby $
//
...
implements Comparable
{
     ...
     */
    public CardSprite (CardImageProvider images, Card card)
    {
        this(images, card, true);
    }
     ...
     */
    public CardSprite (CardImageProvider images, Card card, boolean facingUp)
    {
        _images = images;
        _card = card;
        _facingUp = facingUp;
    ...
    protected void updateMirage ()
    {
        setMirage((_card != null && _facingUp ) ?
            _images.getCardImage(_card) : _images.getCardBackImage());
    }
